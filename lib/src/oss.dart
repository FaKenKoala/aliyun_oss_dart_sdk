...
abstract class OSS {
         ...
         *         contains some basic response options, such as requestId.
         */
        public VoidResult setBucketReferer(String bucketName, BucketReferer referer)
                        throws OSSException, ClientException;
         ...
         *         contains some basic response options, such as requestId.
         */
        public VoidResult setBucketReferer(SetBucketRefererRequest setBucketRefererRequest)
                        throws OSSException, ClientException;
         ...
         *         contains some basic response options, such as requestId.
         */
        public VoidResult setBucketTagging(String bucketName, Map<String, String> tags)
                        throws OSSException, ClientException;
         ...
         *         contains some basic response options, such as requestId.
         */
        public VoidResult setBucketTagging(SetBucketTaggingRequest setBucketTaggingRequest)
                        throws OSSException, ClientException;
         ...
         *                       account
         *                       information and accessed Ids and its signature. The url
         *                       is
         *                       recommended to be generated by generatePresignedUrl().
         * @param filePath
         *                       The file path to read from
         * @param requestHeaders
         *                       Request headers, including standard or customized http
         *                       headers
         ...
         *                         request.
         */
        public VoidResult deleteVersion(String bucketName, String key, String versionId)
                        throws OSSException, ClientException;
         ...
         * @return True if exists; false if not.
         */
        public bool doesObjectExist(GenericRequest genericRequest, bool isOnlyInOSS)
                        throws OSSException, ClientException;
         ...
         *                          A {@link HeadObjectRequest} instance which specifies
         *                          the
         *                          bucket name and object key. Constraint information
         *                          is ignored.
         * @return True if the file exists; false if not.
         */
        @Deprecated
         ...
         *         contains some basic response options, such as requestId.
         */
        public VoidResult setObjectTagging(String bucketName, String key, TagSet tagSet)
                        throws OSSException, ClientException;
         ...
         *         contains some basic response options, such as requestId.
         */
        public VoidResult setObjectTagging(SetObjectTaggingRequest setObjectTaggingRequest)
                        throws OSSException, ClientException;
         ...
         *                         OSS Client side exception.
         */
        public VoidResult setBucketProcess(SetBucketProcessRequest setBucketProcessRequest)
                        throws OSSException, ClientException;
         ...
         * @throws ClientException
         */
        public VoidResult setBucketWebsite(SetBucketWebsiteRequest setBucketWebSiteRequest)
                        throws OSSException, ClientException;
         ...
         *                         OSS Client side exception.
         */
        public VoidResult setBucketStorageCapacity(String bucketName, UserQos userQos)
                        throws OSSException, ClientException;
         ...
         *                         OSS Client side exception.
         */
        public VoidResult setBucketPolicy(SetBucketPolicyRequest setBucketPolicyRequest)
                        throws OSSException, ClientException;
         ...
         *                         OSS Client side exception.
         */
        public GetBucketPolicyResult getBucketPolicy(GenericRequest genericRequest)
                        throws OSSException, ClientException;
         ...
         *                         OSS Client side exception.
         */
        public VoidResult setLiveChannelStatus(SetLiveChannelRequest setLiveChannelRequest)
                        throws OSSException, ClientException;
         ...
         *                         OSS Client side exception.
         */
        public VoidResult generateVodPlaylist(String bucketName, String liveChannelName, String PlaylistName,
                        long startTime,
         ...
         *                         OSS Client side exception.
         */
        public VoidResult createSymlink(String bucketName, String symlink, String target)
                        throws OSSException, ClientException;
         ...
         *                         OSS Client side exception.
         */
        public VoidResult setBucketQosInfo(String bucketName, BucketQosInfo bucketQosInfo)
                        throws OSSException, ClientException;
         ...
         *                         OSS Client side exception.
         */
        public CreateVpcipResult createVpcip(CreateVpcipRequest createVpcipRequest)
                        throws OSSException, ClientException;
         ...
         *                         OSS Client side exception.
         */
        public VoidResult setBucketInventoryConfiguration(String bucketName,
         ...
         *
         */
        public VoidResult deleteBucketInventoryConfiguration(String bucketName, String id)
                        throws OSSException, ClientException;
         ...
         *
         */
        public VoidResult completeBucketWorm(CompleteBucketWormRequest completeBucketWormRequest)
                        throws OSSException, ClientException;
         ...
         *
         */
        public VoidResult extendBucketWorm(String bucketName, String wormId, int retentionPeriodInDays)
                        throws OSSException, ClientException;
         ...
         *         contains some basic response options, such as requestId.
         */
        public VoidResult extendBucketWorm(ExtendBucketWormRequest extendBucketWormRequest)
                        throws OSSException, ClientException;
         ...
         *         contains some basic response options, such as requestId.
         */
        public VoidResult renameObject(String bucketName, String sourceObjectName, String destinationObjectName)
                        throws OSSException, ClientException;
